...
function ResourceForm({
	...
	const isAutoGenerated =
		initialResource?.label === "Tracks" ||
		initialResource?.label === "Challenges";
				...
				<div className="flex flex-col gap-2">
					...
					{isAutoGenerated && (
						<p className="text-xs text-muted-foreground">
							This content is automatically generated from the{" "}
							{initialResource?.label} configuration.
						</p>
					)}
				</div>
			)}
					...
					>
						...
						<div className="flex gap-2">
							...
							<Button
								...
								disabled={
									resource.label === "Tracks" || resource.label === "Challenges"
								}
							>
